...
| Floor/environment | slip, threshold, lighting, stair-edge, door-force checks complete | inspection log / Facilities | ready |
| Charging | dedicated power, clearances, lockout, battery response confirmed | electrical signoff / Facilities | ready |
| Network | route survey, segmented wireless, device identity, outage test | test report / IT Lead | ready |
...
**Readiness decision:** approved for the 30-day controlled pilot after all mandatory rows reached ready. Any route, item-class, camera-purpose, or operating-hours change returns to review.

...
3. Double-click VALIDATE_PORTFOLIO_WINDOWS.bat. The first run creates a local .venv and installs the pinned simulation requirements.
4. Review the generated website in docs\index.html and the workflow evidence in outputs\.
5. Use GitHub Desktop to review the exact diff, commit, and push only after validation succeeds.

Useful entry points:
- README.md — portfolio and repository map
